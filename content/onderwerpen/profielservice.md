...
De profielservice is een van de services die binnen het programma MOZa wordt ontwikkeld. Het doel van deze service is dat ondernemers straks, net als burgers, op één plek hun communicatievoorkeuren en waar relevant contactgegevens, met de overheid beheren.
...
In bovenstaand diagram symboliseert elke pijl een contactvoorkeur. Een contactvoorkeur wordt opgeslagen in de profielservice waarbij meerdere personen gekoppeld kunnen zijn aan meerdere bedrijven. Een zogenaamd N:M-model.
