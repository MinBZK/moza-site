---
title: MOZa Weekly 10 november 2025
summary: MOZa Pulse met terugkoppeling gebruikersonderzoek, gezamenlijke concept roadmap gemaakt tijdens Regieteam overleg, profielservice gegevensmodel online, NeRDS workshops gestart.
date: 2025-11-10
---

## Algemeen

1. Dinsdag hebben we tijdens de MOZa Pulse een eerste terugkoppeling gegeven naar aanleiding van het gebruikersonderzoek. Ook hebben we meer verteld over de profielservice. In de bijlage vind je de slides.
...
2. De eerste sequence-diagrammen zijn gemaakt en [gedeeld](https://docs.mijnoverheidzakelijk.nl/workspace/documentation/Profiel%20Service#positionering-voor-stakeholders) voor:
    - Ondernemer → profielservice
    - Dienstverlener → profielservice
